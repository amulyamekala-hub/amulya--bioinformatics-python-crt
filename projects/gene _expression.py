"""
You're given a dataset containing gene expression levels across multiple timepoints.Your task is to:
Read the data set.Calculate Variance of expression per gene
